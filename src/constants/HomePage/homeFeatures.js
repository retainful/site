            ...
            <div className="row align-items-center">
                ...
                <div className="col-md-6">
                    <div className="features-list">
                        ...
                        <p>
                            <a href="https://www.retainful.com/abandoned-cart-recovery?utm_source=abandoned_cart_recovery&utm_medium=learn_more&utm_campaign=home_page">Learn more  <span><FaLongArrowAltRight/></span></a>
                        </p>
                    </div>
                </div>
            </div>
            <div className="row align-items-center">
                <div className="col-md-6">
                    <div className="features-list">
                        ...
                        <p>
                            <a href="https://www.retainful.com/next-order-coupon?utm_source=drive_repeated_purchases&utm_medium=learn_more&utm_campaign=home_page">Learn more <span><FaLongArrowAltRight/></span></a>
                        </p>
                    </div>
                </div>
                <div className="col-md-6">

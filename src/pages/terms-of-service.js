    ...
    <Layout>
        ...
        <Container type="s">
            <div className="legal-info">
                <p>
                    This Retainful Subscription Terms of Service (“<strong>Terms of Service</strong>” or “<strong>Agreement</strong>“) is entered into by and between the Cartrabbit International Pte Ltd, a company incorporated in Singapore with a principal place of business located at 09-14, High Street Plaza, High Street, Singapore – 179433, on behalf of itself, and subsidiaries and affiliates set forth below (“<strong>Cartrabbit</strong>” or “<strong>Retainful</strong>”) and the entity or person placing an order for or accessing any Services (“<strong>Customer</strong>” or “<strong>you</strong>“). If you are accessing or using the Services on behalf of your company, you represent that you are authorized to accept this Agreement on behalf of your company, and all references to “you” or “Customer” reference your company.
                </p>
                <p>
                    These Terms of Service, together with the Privacy Policy, if applicable pursuant to Section 6.3 below, and any on-line or written order form for the purchase of the Services (as herein defined) (each, a “<strong>Service Order</strong>“), collectively constitute a binding agreement between Cartrabbit and you or the legal entity you represent (“<strong>Customer</strong>” or “<strong>you</strong>“). These Terms of Service also apply if you purchase a right to use the Services (as defined below) pursuant to a Service Order entered into between you and a Retainful-authorized agent, vendor, or reseller of the Services (an “<strong>Authorized Reseller</strong>“).
                </p>
                <p>
                    Customer desires to use Retainful’s online customer management services presently offered or available, (the “<strong>Services</strong>“) using Retainful’s Customer’s instructions and other documentation of Retainful (the “<strong>Retainful Documentation</strong>“). Customer management services include using Retainful software to retrieve customer information from customer emails, websites and similar opt-ins, and transactions (the “<strong>Communications</strong>“), viewing data available from the Communications, and using Retainful’s marketing platform to send messages to end customers through email and SMS text messages. Retainful will permit Customer to use the Services and the Retainful Documentation subject to the terms and conditions of these Terms of Service. By using the Services, Customer agrees to all of the terms and conditions of these Terms of Service, including but not limited to the limitations on liability set forth herein. IF CUSTOMER DOES NOT AGREE TO ALL OF THE TERMS AND CONDITIONS OF THESE TERMS OF SERVICE, CUSTOMER IS NOT PERMITTED TO USE THE SERVICES.
                </p>
                <ol>
                    <li>
                        <h3>SERVICES</h3>
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                <h4>License.</h4>
                                <p>
                                    Subject to the terms and conditions of these Terms of Service, Retainful grants to Customer a non-exclusive, non-transferable, revocable license during the Term (as defined in Section 12), without the right to sublicense, to </p>
                                <ol type="i">
                                    <li>
                                        use the software and other technology supplied by Retainful to enable Customer to receive or access the Services (the “<strong>Retainful Platform</strong>“) solely for the purposes of accessing and using the Services; and
                                    </li>
                                    <li>
                                        use the Retainful Documentation in connection with the Customer’s use of the Retainful Platform. Except for the limited licenses granted hereunder, Retainful reserves all rights not expressly granted and no such additional rights may be implied.
                                    </li>
                                </ol>
                            </li>
                            <li>
                                ...
                                <ol type="i">
                                    <li>
                                        all right, title and interest in and to the Services, including the Retainful Platform and Retainful Documentation therein, and all patents, copyrights, trade secrets, trademarks, trade names, service marks, slogans, logos, other trade-identifying symbols and other proprietary and intellectual property rights embodied therein or associated therewith, are and shall remain with Retainful or its third party licensors;
                                    </li>
                                    <li>
                                        no right or interest in the Services or the Retainful Platform is conveyed other than the limited licenses granted herein;
                                    </li>
                                    <li>
                                        the Services, the Retainful Documentation and the Retainful Platform are protected by copyright and other intellectual property laws; and
                                    </li>
                                    <li>
                                        Retainful asserts that the Services, the Retainful Documentation and the Retainful Platform embody valuable confidential and secret information of Retainful or its licensors, the development of which required the expenditure of considerable time and money.
                                    </li>
                                </ol>
                            </li>
                            <li>
                                ...
                                <ol type="i">
                                    ...
                                    <li>
                                        decompile, disassemble, decode or reverse engineer the Retainful Platform, translate the Retainful Platform or otherwise attempt to learn the source code, structure, algorithms or internal ideas underlying the Retainful Platform or reduce the Retainful Platform by any other means to a human perceivable form; or
                                    </li>
                                    <li>
                                        bypass, delete or disable any copy protection mechanisms or any security mechanisms.
                                    </li>
                                </ol>
                            </li>
                            <li>
                                ...
                                <p>
                                    In connection with the Services, Customer grants Retainful and Third-Party Partner Site(s) a non-exclusive, transferable, royalty-free license during the Term to use Customer’s trademarks, trade names, service marks, slogans, logos, other trade-identifying symbols and all other marketing or promotional content provided by Customer to Retainful (“<strong>Customer Marketing Content</strong>“) in connection with the advertising, promotion and sale of Customer’s products, services or business, and to sublicense such Customer Marketing Content to third parties in connection with the provision of such Services. Customer acknowledges that any on-line coupon or similar marketing offer, deal or advertisement to market its products or services (each, an “<strong>Offer</strong>“) posted on Third-Party Partner Site(s) may not carry the Retainful trademark or branding. Customer further acknowledges and agrees that Retainful or its sublicensees may modify Customer Marketing Content in order to effectively provide the Services ordered in Retainful’s reasonable discretion, provided, that none of such modifications shall materially alter the terms of any Offer without Customer’s prior written consent.
                                </p>
                            </li>
                            <li>
                                ...
                                <ol type="i">
                                    <li>
                                        shall not sell, transfer, lend, provide or otherwise make available, or disclose to third parties, the Services or any components thereof;
                                    </li>
                                    <li>
                                        shall not obscure, alter or remove any notice of any copyright, trademark, trade name, service mark, logo, or other intellectual property or proprietary right designation appearing on or contained within the Services, the Retainful Platform, the Documentation or on any other Retainful materials; and
                                    </li>
                                    <li>
                                        shall take all reasonable precautions to prevent unauthorized or improper use of the Services.
                                    </li>
                                </ol>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p>
                                    In the event Customer elects, in connection with any of the Services, to communicate to Retainful (either directly or through an Authorized Reseller) suggestions for improvements to the Services (“<strong>Feedback</strong>“), Retainful shall be entitled to use the Feedback without restriction and Feedback will not be treated as confidential to Customer. Customer hereby grants to Retainful a royalty-free, sub-licensable, transferable, perpetual, irrevocable worldwide license in and to the Feedback to use in any manner related to the operation of its business. In addition, Retainful hereby disclaims any and all liability for any comments, drawings, depictions, audio clips or other content made available on the Retainful Site by Customers of the Retainful Site generally (“<strong>Comments</strong>“). Further Retainful
                                </p>
                                <ol type="i">
                                    <li>
                                        shall have a royalty-free, sub licensable, transferable, perpetual, worldwide, irrevocable license in and to such Comments to use in any manner related to the operation of its business, and
                                    </li>
                                    <li>
                                        reserves the right to remove any such Content from the Retainful Site immediately in its sole discretion.
                                    </li>
                                </ol>
                            </li>
                        </ol>
                    ...
                    <li>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <ol type="i">
                                    <li>
                                        that Retainful determines, in its sole discretion, that the Services are being used in violation of applicable federal, state or local law or ordinance, these Terms of Service, or any agreement applicable to the Services;
                                    </li>
                                    <li>
                                        that Retainful, in its sole discretion, determines that the Services are being used in an unauthorized, inappropriate, or fraudulent manner;
                                    </li>
                                    <li>
                                        that Retainful determines that the use of the Services adversely affects Retainful’s equipment or service to others;
                                    </li>
                                    <li>
                                        Retainful is prohibited by an order of a court or other governmental agency from providing the Services;
                                    </li>
                                    <li>
                                        of a denial of service attack or any other event which Retainful determines, in its sole discretion, may create a risk to the Services or to any other customers if the Services were not suspended; or
                                    </li>
                                    <li>
                                        of a security incident or other disaster that impacts the Services or the security of Customer Data. In addition, Retainful shall have the right to immediately deny or suspend access to the Retainful Platform or Services in the event Retainful, or if applicable, an Authorized Reseller, is not paid any amount due in connection with the Services or Customer’s breach or alleged breach of these Terms of Service. Without limiting the generality of Section 5, Retainful shall have no liability for any damages, liabilities or losses as a result of any suspension, limitation or termination of Customer‘s right to use the Services in accordance with these Terms of Service.
                                    </li>
                                </ol>
                            </li>
                            <li>
                                ...
                                <ol type="i">
                                    <li>
                                        in violation of these Terms of Service, including usage that exceeds storage volume limits or other parameters and restrictions described on the applicable Service Order or on the Retainful Site;
                                    </li>
                                    <li>
                                        to infringe on, violate, dilute or misappropriate the intellectual property rights of any third party or any rights of publicity or privacy;
                                    </li>
                                    <li>
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                ...
                                <ol type="i">
                                    <li>
                                        Customer has full corporate right, power and authority to enter into these Terms of Service,
                                    </li>
                                    <li>
                                        the execution of these Terms of Service by and the performance of its obligations and duties hereunder do not and will not violate any agreement to which Customer is a party or by which Customer is bound, and
                                    </li>
                                    <li>
                                        when executed and delivered, these Terms of Service will constitute your legal, valid and binding obligation, in accordance with its terms.
                                    </li>
                                </ol>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ol type="i">
                                    ...
                                    <li>
                                        that Customer has the necessary rights and licenses, consents, permissions, waivers and releases to use the Customer Data and to enable Retainful to use and disclose to Customer the Customer Data as intended by the parties under these Terms of Service and the terms of any applicable Service Orders;
                                    </li>
                                    <li>
                                        that Customer has a legally sufficient privacy policy or privacy notice that is made available to customers prior to their provision of any Personal Information to Customer or Retainful;
                                    </li>
                                    <li>
                                        that use by Retainful of Customer Data (a) does not violate, misappropriate or infringe any rights of Retainful or any third party, (b) does not constitute defamation, invasion of privacy or publicity, or otherwise violate any rights of any third party, and (c) is not designed for use in any illegal activity or does not promote illegal activities, including, without limitation, in a manner that might be illegal or harmful to any person or entity; or
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ol type="i">
                                    <li>
                                        the information Customer provides in connection with Customer’s registration for the Services is accurate and complete;
                                    </li>
                                    <li>
                                        if Customer is registering for the Services as an individual, that Customer is at least 18 years of age and has the legal capacity to enter into these Terms of Service; and
                                    </li>
                                    <li>
                                        if registering for the Services as an entity or organization, (a) Customer is duly authorized to do business in the country or countries and state and local jurisdictions where it operates, (b) the individual accepting these Terms of Service and completing the registration for the Services meets the requirements of subsection
                                    </li>
                                    <li>
                                        above and is an authorized representative of Customer, and (c) Customer’s employees, officers, representatives and other agents accessing the Services are duly authorized to access the Services and to legally bind Customer to these Terms of Service and all transactions conducted under Customer’s account.
                                    </li>
                                </ol>
                            </li>
                        </ol>
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                ...
                                <ol type="i">
                                    <li>
                                        content provided by or passed through Customer or third-parties in connection with the Services (including Customer Data);
                                    </li>
                                    <li>
                                        operating system or other technology modifications, changes or updates applied by the Customer;
                                    </li>
                                    <li>
                                        the use or combination of the Retainful Platform or the Services with any other software or hardware not supported by Retainful;
                                    </li>
                                    <li>
                                        causes external to the Retainful Platform or the Services, such as problems with the hardware, network or other infrastructure with which the Retainful Platform and the Services are used;
                                    </li>
                                    <li>
                                        unauthorized or improper use of the Retainful Platform or the Services; or
                                    </li>
                                    <li>
                                        any modification of the Retainful Platform or the Services by anyone other than Retainful.
                                    </li>
                                </ol>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <p>
                            Customer will indemnify and hold Retainful, its Partners, its and their investors, officers, directors, affiliates, subsidiaries, licensors, agents and employees (collectively, the “<strong>Retainful Parties</strong>“) harmless against any loss, liability, claim, demand, damages, penalties, settlements, costs and expenses, including reasonable attorney’s fees, resulting from any claim (including third party claims), suit, action or proceeding against a Retainful Party, resulting from or arising out of or in connection with
                        </p>
                        <ol type="i">
                            <li>
                                claims of intellectual property infringement based on (A) Customer’s use or combination of the Retainful Platform and the Services with any other software or hardware not supported by Retainful, if such infringement would not have occurred but for such use or combination; (B) any modification of the Retainful Platform and the Services by Customer; or (C) the use by Customer of any version of the Retainful Platform and/or Services other than the current version of the Retainful Platform and/or Services, if such version was made available by Retainful with notice that such version was being provided in order to avoid an alleged or potential infringement;
                            </li>
                            <li>
                                claims relating to the Offers or the fulfillment thereof (including claims by purchasers or other Customers of the Offers on the Retainful Site or Third-Party Partner Site relating to Customer’s products or services); or
                            </li>
                            <li>
                                any breach by Customer of any representation, warranty or obligation under these Terms of Service; or
                            </li>
                            <li>
                                the use, transmission, access,  disclosure, or other processing of Customer Data. Retainful does not knowingly collect, either online or offline, Personal Information from persons under the age of thirteen (13). Customer agrees to indemnify Retainful if, as a result of Communications, Retainful collects Customer Data from persons under the age of 13.
                            </li>
                        </ol>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                Identification of the copyrighted work that you believe to be infringed. Please describe the work, and where possible include a copy or the location (URL) of an authorized version of the work.
                            </li>
                            <li>
                ...
                <p>
                    If Customer has any questions or concerns about what has been stated in this Terms of Service, please contact us at <a href="mailto:legal@cartrabbit.io">legal@cartrabbit.io</a>
                </p>
            </div>
        </Container>
    </Layout>
